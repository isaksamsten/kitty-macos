...
def generate_wrappers(glfw_header: str) -> None:
    ...
    int background_blur, unsigned int hide_window_decorations, bool show_text_in_titlebar, int color_space, float background_opacity, bool resizable, bool tabs_hidden)
